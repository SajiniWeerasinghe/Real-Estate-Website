...
const Testimonials = () => {
    return (
        <motion.div
            ...
            <p className='text-center text-gray-500 mb-8 max-w-80 mx-auto'>Hear from our happy clients
                    ...
                    <div key={index} className='max-w-[340px] border shadow-lg rounded px-8 py-12 text-center'>
                        ...
                        <div className='flex justify-center gap-1 text-red-500 mb-4'>
                            {Array.from({ length: testimonial.rating }, (item, index) => (
                                <img key={index} className='inline-block w-4 h-4' src={assets.star_icon} alt='Star Icon' />
                            ))}
                        </div>
