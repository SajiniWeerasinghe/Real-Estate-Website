...
const Projects = () => {
    ...
    useEffect(() => {
        const updateCardsToShow = () => {
            if (window.innerWidth >= 1024) {
                ...
                setCardsToShow(1); // Default to 1 card on smaller screens
            }
        };
        updateCardsToShow(); // Initial call to set cardsToShow based on current window size
    ...
    return (
        <motion.div
            ...
            <p className='text-center text-gray-500 mb-8 max-w-80 mx-auto'>Delivering quality homes with trust, one project at a time.</p>

            {/* slider button */}
            <div className='flex  justify-end items-center mb-8'>
                <button onClick={prevProject} className='p-3 bg-gray-200 rounded mr-2' aria-label='Previous Project'><img src={assets.left_arrow} alt="prev" /></button>
